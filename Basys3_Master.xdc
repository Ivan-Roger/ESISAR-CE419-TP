...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {disp_led[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_led[0]}]
set_property PACKAGE_PIN E19 [get_ports {disp_led[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_led[1]}]
set_property PACKAGE_PIN U19 [get_ports {disp_led[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_led[2]}]
set_property PACKAGE_PIN V19 [get_ports {disp_led[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_led[3]}]
set_property PACKAGE_PIN W18 [get_ports {disp_led[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_led[4]}]
set_property PACKAGE_PIN U15 [get_ports {disp_led[5]}]	
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_led[5]}]
set_property PACKAGE_PIN U14 [get_ports {disp_led[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_led[6]}]
set_property PACKAGE_PIN V14 [get_ports {disp_led[7]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {disp_led[7]}]
...
set_property PACKAGE_PIN N3 [get_ports {clk2_out}]
	set_property IOSTANDARD LVCMOS33 [get_ports {clk2_out}]
set_property PACKAGE_PIN P1 [get_ports {ack_out}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ack_out}]
set_property PACKAGE_PIN L1 [get_ports {req_out}]
	set_property IOSTANDARD LVCMOS33 [get_ports {req_out}]
...
set_property PACKAGE_PIN V7 [get_ports disp_dp]
...
#set_property PACKAGE_PIN T17 [get_ports send_next]
#	set_property IOSTANDARD LVCMOS33 [get_ports send_next]
